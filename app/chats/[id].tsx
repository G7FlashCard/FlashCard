...
import type { ChatMessage, Conversation } from "../../screens/chatStore";
        ...
        <View style={styles.header}>
          ...
          <View style={styles.headerText}>
            ...
            <View style={styles.statusRow}>
              ...
              <Text style={[styles.status, convo.kind === "direct" && convo.online && styles.statusOnline]}>
                {subtitle}
              </Text>
            </View>
          </View>
  ...
  return (
    <View style={[styles.theirsRow, gap]}>
      <View style={styles.avatarSlot}>
        {firstOfRun ? <Avatar name={message.from} size={36} /> : null}
      </View>
